...
var rfcVectors = []struct {
...
}{
	{
		...
		custom: nil,
		outLen: 32,
		want:   testdata.MustHex("1AC2D450FC3B4205D19DA7BFCA1B37513C0803577AC7167F06FE2CE1F0EF39E5"),
	},
	{
		name:   "empty/empty/64",
		msg:    nil,
	...
	},
	{
		...
		custom: nil,
		outLen: 10032,
		want:   testdata.MustHex("E8DC563642F7228C84684C898405D3A834799158C079B12880277A1D28E2FF6D"),
		last32: true,
	},
	{
		name:   "ptn(1)/empty/32",
		...
		custom: nil,
		outLen: 32,
		want:   testdata.MustHex("2BDA92450E8B147F8A7CB629E784A058EFCA7CF7D8218E02D345DFAA65244A1F"),
	},
	{
		...
		custom: nil,
		outLen: 32,
		want:   testdata.MustHex("6BF75FA2239198DB4772E36478F8E19B0F371205F6A9A93A273F51DF37122888"),
	},
	{
		...
		custom: nil,
		outLen: 32,
		want:   testdata.MustHex("0C315EBCDEDBF61426DE7DCF8FB725D1E74675D7F5327A5067F367B108ECB67C"),
	},
	{
		...
		custom: nil,
		outLen: 32,
		want:   testdata.MustHex("CB552E2EC77D9910701D578B457DDF772C12E322E4EE7FE417F92C758F0D59D0"),
	},
	{
		...
		custom: nil,
		outLen: 32,
		want:   testdata.MustHex("8701045E22205345FF4DDA05555CBB5C3AF1A771C2B89BAEF37DB43D9998B9FE"),
	},
	{
		...
		custom: nil,
		outLen: 32,
		want:   testdata.MustHex("844D610933B1B9963CBDEB5AE3B6B05CC7CBD67CEEDF883EB678A0A8E0371682"),
	},
	{
		...
		custom: nil,
		outLen: 32,
		want:   testdata.MustHex("3C390782A8A4E89FA6367F72FEAAF13255C8D95878481D3CD8CE85F58E880AF8"),
	},
	{
		name:   "empty/ptn(1)/32",
		msg:    nil,
		custom: ptn(1),
		outLen: 32,
		want:   testdata.MustHex("FAB658DB63E94A246188BF7AF69A133045F46EE984C56E3C3328CAAF1AA1A583"),
	},
	{
		name:   "0xFF/ptn(41)/32",
		msg:    []byte{0xFF},
		custom: ptn(41),
		outLen: 32,
		want:   testdata.MustHex("D848C5068CED736F4462159B9867FD4C20B808ACC3D5BC48E0B06BA0A3762EC4"),
	},
	{
		...
		custom: ptn(1681),
		outLen: 32,
		want:   testdata.MustHex("C389E5009AE57120854C2E8C64670AC01358CF4C1BAF89447A724234DC7CED74"),
	},
	{
		...
		custom: ptn(68921),
		outLen: 32,
		want:   testdata.MustHex("75D2F86A2E644566726B4FBCFC5657B9DBCF070C7B0DCA06450AB291D7443BCF"),
	},
	{
		...
		custom: nil,
		outLen: 32,
		want:   testdata.MustHex("1B577636F723643E990CC7D6A659837436FD6A103626600EB8301CD1DBE553D6"),
	},
	{
		...
		custom: nil,
		outLen: 32,
		want:   testdata.MustHex("48F256F6772F9EDFB6A8B661EC92DC93B95EBD05A08A17B39AE3490870C926C3"),
	},
	{
		...
		custom: ptn(8189),
		outLen: 32,
		want:   testdata.MustHex("3ED12F70FB05DDB58689510AB3E4D23C6C603384 9AA01E1D8C220A297FEDCD0B"),
	},
	{
		...
		custom: ptn(8190),
		outLen: 32,
		want:   testdata.MustHex("6A7C1B6A5CD0D8C9CA943A4A216CC646045 59A2EA45F78570A15253D67BA00AE"),
	},
}
