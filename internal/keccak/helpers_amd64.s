...
TEXT ·fastLoopAbsorb168x2(SB), $824-32
	...
	MOVOU	0*16(DI), X0;  MOVOU	X0, 0*16(SP)
	MOVOU	1*16(DI), X0;  MOVOU	X0, 1*16(SP)
	MOVOU	2*16(DI), X0;  MOVOU	X0, 2*16(SP)
	MOVOU	3*16(DI), X0;  MOVOU	X0, 3*16(SP)
	MOVOU	4*16(DI), X0;  MOVOU	X0, 4*16(SP)
	MOVOU	5*16(DI), X0;  MOVOU	X0, 5*16(SP)
	MOVOU	6*16(DI), X0;  MOVOU	X0, 6*16(SP)
	MOVOU	7*16(DI), X0;  MOVOU	X0, 7*16(SP)
	MOVOU	8*16(DI), X0;  MOVOU	X0, 8*16(SP)
	MOVOU	9*16(DI), X0;  MOVOU	X0, 9*16(SP)
	MOVOU	10*16(DI), X0; MOVOU	X0, 10*16(SP)
	MOVOU	11*16(DI), X0; MOVOU	X0, 11*16(SP)
	MOVOU	12*16(DI), X0; MOVOU	X0, 12*16(SP)
	MOVOU	13*16(DI), X0; MOVOU	X0, 13*16(SP)
	MOVOU	14*16(DI), X0; MOVOU	X0, 14*16(SP)
	MOVOU	15*16(DI), X0; MOVOU	X0, 15*16(SP)
	MOVOU	16*16(DI), X0; MOVOU	X0, 16*16(SP)
	MOVOU	17*16(DI), X0; MOVOU	X0, 17*16(SP)
	MOVOU	18*16(DI), X0; MOVOU	X0, 18*16(SP)
	MOVOU	19*16(DI), X0; MOVOU	X0, 19*16(SP)
	MOVOU	20*16(DI), X0; MOVOU	X0, 20*16(SP)
	MOVOU	21*16(DI), X0; MOVOU	X0, 21*16(SP)
	MOVOU	22*16(DI), X0; MOVOU	X0, 22*16(SP)
	MOVOU	23*16(DI), X0; MOVOU	X0, 23*16(SP)
	MOVOU	24*16(DI), X0; MOVOU	X0, 24*16(SP)
...
done_x2:
	...
	LEAQ	0(SP), R8
	MOVOU	0*16(R8), X0;  MOVOU	X0, 0*16(DI)
	MOVOU	1*16(R8), X0;  MOVOU	X0, 1*16(DI)
	MOVOU	2*16(R8), X0;  MOVOU	X0, 2*16(DI)
	MOVOU	3*16(R8), X0;  MOVOU	X0, 3*16(DI)
	MOVOU	4*16(R8), X0;  MOVOU	X0, 4*16(DI)
	MOVOU	5*16(R8), X0;  MOVOU	X0, 5*16(DI)
	MOVOU	6*16(R8), X0;  MOVOU	X0, 6*16(DI)
	MOVOU	7*16(R8), X0;  MOVOU	X0, 7*16(DI)
	MOVOU	8*16(R8), X0;  MOVOU	X0, 8*16(DI)
	MOVOU	9*16(R8), X0;  MOVOU	X0, 9*16(DI)
	MOVOU	10*16(R8), X0; MOVOU	X0, 10*16(DI)
	MOVOU	11*16(R8), X0; MOVOU	X0, 11*16(DI)
	MOVOU	12*16(R8), X0; MOVOU	X0, 12*16(DI)
	MOVOU	13*16(R8), X0; MOVOU	X0, 13*16(DI)
	MOVOU	14*16(R8), X0; MOVOU	X0, 14*16(DI)
	MOVOU	15*16(R8), X0; MOVOU	X0, 15*16(DI)
	MOVOU	16*16(R8), X0; MOVOU	X0, 16*16(DI)
	MOVOU	17*16(R8), X0; MOVOU	X0, 17*16(DI)
	MOVOU	18*16(R8), X0; MOVOU	X0, 18*16(DI)
	MOVOU	19*16(R8), X0; MOVOU	X0, 19*16(DI)
	MOVOU	20*16(R8), X0; MOVOU	X0, 20*16(DI)
	MOVOU	21*16(R8), X0; MOVOU	X0, 21*16(DI)
	MOVOU	22*16(R8), X0; MOVOU	X0, 22*16(DI)
	MOVOU	23*16(R8), X0; MOVOU	X0, 23*16(DI)
	MOVOU	24*16(R8), X0; MOVOU	X0, 24*16(DI)
	RET
