...
// 2x parallel Keccak-p[1600, 12] using ARM64 NEON.
//
// The existing KECCAK_ROUND macro uses 128-bit operations (.D2/.B16) on
// VEOR3, VRAX1, VXAR, VBCAX. The 1x code loads only the lower 64-bit half
// (.D1). For 2x we load both halves — state A in the lower lane and state B
// in the upper lane — and the same macro produces correct results for both
...
TEXT ·p1600x2(SB), NOSPLIT, $0-16
	...
	// Load state B and merge into upper halves via ZIP1
	// Batch: lanes 0-3
	MOVD	R3, R4             // save b pointer for storing
	VLD1.P	32(R3), [V25.D1, V26.D1, V27.D1, V28.D1]
	VZIP1	V25.D2, V0.D2, V0.D2
	VZIP1	V26.D2, V1.D2, V1.D2
	VZIP1	V27.D2, V2.D2, V2.D2
	VZIP1	V28.D2, V3.D2, V3.D2

	// Batch: lanes 4-7
	VLD1.P	32(R3), [V25.D1, V26.D1, V27.D1, V28.D1]
	VZIP1	V25.D2, V4.D2, V4.D2
	VZIP1	V26.D2, V5.D2, V5.D2
	VZIP1	V27.D2, V6.D2, V6.D2
	VZIP1	V28.D2, V7.D2, V7.D2

	// Batch: lanes 8-11
	VLD1.P	32(R3), [V25.D1, V26.D1, V27.D1, V28.D1]
	VZIP1	V25.D2, V8.D2, V8.D2
	VZIP1	V26.D2, V9.D2, V9.D2
	VZIP1	V27.D2, V10.D2, V10.D2
	VZIP1	V28.D2, V11.D2, V11.D2

	// Batch: lanes 12-15
	VLD1.P	32(R3), [V25.D1, V26.D1, V27.D1, V28.D1]
	VZIP1	V25.D2, V12.D2, V12.D2
	VZIP1	V26.D2, V13.D2, V13.D2
	VZIP1	V27.D2, V14.D2, V14.D2
	VZIP1	V28.D2, V15.D2, V15.D2

	// Batch: lanes 16-19
	VLD1.P	32(R3), [V25.D1, V26.D1, V27.D1, V28.D1]
	VZIP1	V25.D2, V16.D2, V16.D2
	VZIP1	V26.D2, V17.D2, V17.D2
	VZIP1	V27.D2, V18.D2, V18.D2
	VZIP1	V28.D2, V19.D2, V19.D2

	// Batch: lanes 20-23
	VLD1.P	32(R3), [V25.D1, V26.D1, V27.D1, V28.D1]
	VZIP1	V25.D2, V20.D2, V20.D2
	VZIP1	V26.D2, V21.D2, V21.D2
	VZIP1	V27.D2, V22.D2, V22.D2
	VZIP1	V28.D2, V23.D2, V23.D2
...
loop2x:
	...
	// Store state B (extract upper halves via EXT, then store lower halves)
	// Batch: lanes 0-3
	VEXT	$8, V0.B16, V0.B16, V25.B16
	VEXT	$8, V1.B16, V1.B16, V26.B16
	VEXT	$8, V2.B16, V2.B16, V27.B16
	VEXT	$8, V3.B16, V3.B16, V28.B16
	VST1.P	[V25.D1, V26.D1, V27.D1, V28.D1], 32(R4)

	// Batch: lanes 4-7
	VEXT	$8, V4.B16, V4.B16, V25.B16
	VEXT	$8, V5.B16, V5.B16, V26.B16
	VEXT	$8, V6.B16, V6.B16, V27.B16
	VEXT	$8, V7.B16, V7.B16, V28.B16
	VST1.P	[V25.D1, V26.D1, V27.D1, V28.D1], 32(R4)

	// Batch: lanes 8-11
	VEXT	$8, V8.B16, V8.B16, V25.B16
	VEXT	$8, V9.B16, V9.B16, V26.B16
	VEXT	$8, V10.B16, V10.B16, V27.B16
	VEXT	$8, V11.B16, V11.B16, V28.B16
	VST1.P	[V25.D1, V26.D1, V27.D1, V28.D1], 32(R4)

	// Batch: lanes 12-15
	VEXT	$8, V12.B16, V12.B16, V25.B16
	VEXT	$8, V13.B16, V13.B16, V26.B16
	VEXT	$8, V14.B16, V14.B16, V27.B16
	VEXT	$8, V15.B16, V15.B16, V28.B16
	VST1.P	[V25.D1, V26.D1, V27.D1, V28.D1], 32(R4)

	// Batch: lanes 16-19
	VEXT	$8, V16.B16, V16.B16, V25.B16
	VEXT	$8, V17.B16, V17.B16, V26.B16
	VEXT	$8, V18.B16, V18.B16, V27.B16
	VEXT	$8, V19.B16, V19.B16, V28.B16
	VST1.P	[V25.D1, V26.D1, V27.D1, V28.D1], 32(R4)

	// Batch: lanes 20-23
	VEXT	$8, V20.B16, V20.B16, V25.B16
	VEXT	$8, V21.B16, V21.B16, V26.B16
	VEXT	$8, V22.B16, V22.B16, V27.B16
	VEXT	$8, V23.B16, V23.B16, V28.B16
	VST1.P	[V25.D1, V26.D1, V27.D1, V28.D1], 32(R4)

	// Lane 24
	VEXT	$8, V24.B16, V24.B16, V25.B16
	VST1	[V25.D1], (R4)

	RET

// Round constants (file-local copy since <>-scoped symbols can't be shared).
